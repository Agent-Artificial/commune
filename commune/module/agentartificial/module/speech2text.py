...
class Speech2Text(InferenceGenerator, Module):
    description = "Converts audio and video into a text transcript. Accepts mp3, wav, mp4,  and mkv formats. Uses a locally developed Whisper model."
    whitelist = [
        "forward"
        ]
    def __init__(
    ...
    def generate(self, endpoint: Endpoints, **kwargs):
        """
    ...
    def construct_url(self) -> str:
        ...
        """
        return self.base_url + str(Endpoints.SPEECH2TEXT)
